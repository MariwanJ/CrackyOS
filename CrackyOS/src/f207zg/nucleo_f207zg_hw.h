...
#ifndef NUCLEO_F207ZG_HW_h
#define NUCLEO_F207ZG_HW_h
...
/**
 * Check if the script program has a valid PWM pin name.
 *
 * STM32F207ZG:
 * Pins with TIMx_CHy or TIMx_CHyN alternate functions.
 */
inline int correctPWMpinName(int currentToken) {
  ...
  case TOKEN_PA_7:  // TIM3_CH2 / TIM14_CH1 / TIM1_CH1N
  ...
  // Port B
  case TOKEN_PB_0:  // TIM3_CH3 / TIM1_CH2N
  case TOKEN_PB_1:  // TIM3_CH4 / TIM1_CH3N
...
/**
 * Check if the script program has a valid CAN pin name.
 *
 * STM32F207ZG has two CAN peripherals:
 *   CAN1: PA11/PA12, PB8/PB9, PD0/PD1
 *   CAN2: PB5/PB6, PB12/PB13
 */
inline int correctCANpinName(int word) {
  switch (word) {
  // CAN1
  case TOKEN_PA_11: // CAN1_RX
  case TOKEN_PA_12: // CAN1_TX

  case TOKEN_PB_8: // CAN1_RX
  case TOKEN_PB_9: // CAN1_TX

  case TOKEN_PD_0: // CAN1_RX
  case TOKEN_PD_1: // CAN1_TX

  // CAN2
  case TOKEN_PB_5: // CAN2_RX
  case TOKEN_PB_6: // CAN2_TX

  case TOKEN_PB_12: // CAN2_RX
  case TOKEN_PB_13: // CAN2_TX
    return 1;
