...
void add_Reserved_GPIO(void) {
    ...
    //Serial PC  - SERIAL 3
    GlobalGPIO_REG->add(TOKEN_PD_8, FTOKEN_SERIAL_TX);
    GlobalGPIO_REG->add(TOKEN_PD_9, FTOKEN_SERIAL_RX);
    //  PC_10, PC_11 SERIAL 4
    GlobalGPIO_REG->add(TOKEN_PC_10, FTOKEN_SERIAL_TX);
    GlobalGPIO_REG->add(TOKEN_PC_11, FTOKEN_SERIAL_RX);
    //Master SPI 2 used for SD and all other SPI devices.

    GlobalGPIO_REG->add(TOKEN_PB_5, FTOKEN_SPI_MOSI);
    GlobalGPIO_REG->add(TOKEN_PA_6, FTOKEN_SPI_MISO);
    GlobalGPIO_REG->add(TOKEN_PA_5, FTOKEN_SPI_CLK);
    GlobalGPIO_REG->add(TOKEN_PD_14, FTOKEN_SPI_CS);
    //I2C1
    GlobalGPIO_REG->add(TOKEN_PB_8, FTOKEN_I2C_CLK);
    GlobalGPIO_REG->add(TOKEN_PB_9, FTOKEN_I2C_SDA);
    //CAN  CAN_1_RD, CAN_1_TD
    GlobalGPIO_REG->add(PD_0, FTOKEN_CAN_RD);
    GlobalGPIO_REG->add(PD_1, FTOKEN_CAN_TD);
    // ENCODER
...
const token_exchanger token_exchange_list[]{
    ...
    {"pb_0"                      ,                           TOKEN_PB_0                 ,1237143384         },
    {"pb_1"                      ,                           TOKEN_PB_1                 ,1253921003         },
    {"pb_2"                      ,                           TOKEN_PB_2                 ,1270698622         },
    {"pb_3"                      ,                           TOKEN_PB_3                 ,1287476241         },
    {"pb_4"                      ,                           TOKEN_PB_4                 ,1304253860         },
    {"pb_5"                      ,                           TOKEN_PB_5                 ,1321031479         },
    {"pb_6"                      ,                           TOKEN_PB_6                 ,1337809098         },
    {"pb_7"                      ,                           TOKEN_PB_7                 ,1354586717         },
    {"pb_8"                      ,                           TOKEN_PB_8                 ,1102922432         },
    {"pb_9"                      ,                           TOKEN_PB_9                 ,1119700051         },
